...
import 'package:paseador_mascotas/pages/home_page.dart';
import 'package:paseador_mascotas/pages/registrar_page.dart';
  ...
  void mostrarMensaje(String mensaje){
    ...
    pantalla.showSnackBar(
      SnackBar(
        ...
        backgroundColor: const Color(0xFF03C310),
        ...
        child: Padding(
          ...
          child: Center(
            child: Column(
              children: [
                Container(
                  child: const Image( image: AssetImage("assets/images/chico.png"), width: 120, height: 120),
